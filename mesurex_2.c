...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Description :
// Le véhicule, il roule suivant une ligne droite,
// lorsque le véhicule rencontre un obstacle entre
// 5 et 15 cm, il ralentit puis tourne selon une certaine direction.
// Il calcule au final la distance parcourue.
// -----------------------------------------------------------------
// A noter :
...
/* Fonction qui va tourner les roues d'un angle donné.
 	si le parametre vaut 1, la roue droite tourne.
 	sinon la roue gauche tourne.
*/
...
task main()
{
	...
	while(true){
		...
		if(getButtonPress(buttonUp)){
			...
			// sur le bouton entré.
			stopMultipleMotors(motorA, motorB, motorC);
